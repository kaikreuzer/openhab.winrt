...
{
    class RollershutterWidget : AbstractWidget, IRollershutterWidget
    {

        public RollershutterWidget(RollershutterWidget widget)
        {
        ...
        public RollershutterWidget(Widget widget)
        {
            this.widgetId = widget.widgetId;
            this.type = widget.type;
            this.label = widget.label;
